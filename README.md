...
- No painel admin: paginação/busca nas tabelas de Clientes e Vendas (hoje carregam tudo de uma vez, ok pros ~18 filmes/poucos usuários de um projeto de estudo, mas não escalaria)
...
- O painel admin cobre o pedido original (clientes, vendas, produtos com CRUD completo, devoluções, os 3 relatórios com gráfico e um login escondido) — falta só paginação nas listas maiores (ver "O que ainda falta" na seção de Frontend)
